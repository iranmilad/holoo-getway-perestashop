...
cmd /k "cd /d D:\xampp\htdocs\holoo-getway-perestashop & php artisan queue:monitor redis:high,redis:medium,redis:default,redis:low,redis:deployments --max=100"